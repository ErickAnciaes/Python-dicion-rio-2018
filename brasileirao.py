...
def qtos_libertadores(dados):
    quant_libertadores = dados["fases"]["2700"]["faixas-classificacao"]["classifica1"]["faixa"]
    return int(quant_libertadores.split("-")[1])
...
def ids_dos_melhor_classificados(dados,numero_de_times):
    ...
    while i < numero_de_times:
        melhores.append(dados["fases"]["2700"]["classificacao"]["grupo"]["Único"][i])
        i += 1
...
def classificados_libertadores(dados):
    ...
    i=0
    quant_libertadores = dados["fases"]["2700"]["faixas-classificacao"]["classifica1"]["faixa"]
    numero_classificados = int(quant_libertadores.split("-")[1])

    while i < numero_classificados:
        classificados.append(dados["fases"]["2700"]["classificacao"]["grupo"]["Único"][i])
        i += 1
...
def nomes_classificados_libertadores(dados):
    ...
    while i < numero_classificados:
        id_classificado = dados["fases"]["2700"]["classificacao"]["grupo"]["Único"][i]
        nome_classificados.append(dados["equipes"][id_classificado]["nome-comum"])
        i += 1

    return nome_classificados 
...
def nomes_dos_times_de_um_jogo(dados,id_jogo):
   ...
   time1 = dados["equipes"][id_time1]["nome-comum"]
   time2 = dados["equipes"][id_time2]["nome-comum"]
